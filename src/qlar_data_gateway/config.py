...
def _new_env_file_header() -> list[str]:
    ...
    """
    return [
        "# Qlar Data Gateway - configuration",
        "#",
        "# Generated by `qlar-gateway --init`. Real environment variables take precedence",
        ...
        "# control. Re-run `qlar-gateway run --init` to change these answers.",
        "#",
